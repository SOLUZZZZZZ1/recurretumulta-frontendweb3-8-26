...
export default function DocumentosCore() {
  ...
  return (
    <>
      <Seo
        title="Adjuntar documentación · RTM"
        description="Adjunta el documento principal de tu caso y cualquier otra documentación relacionada."
      ...
      >
        ...
        >
          <header style={{ marginBottom: 24 }}>
            ...
            >
              Adjunta la documentación de tu caso
            </h1>

            <p style={{ margin: 0, color: "#475569", fontSize: 17, lineHeight: 1.6 }}>
              Sube el documento principal relacionado con tu problema y cualquier otra documentación que pueda ayudarnos a entenderlo.
            </p>
          </header>
          ...
          >
            ...
            <div>
              Por ejemplo: <strong>multa, notificación, carta, resolución, factura,
              contrato, reserva, comunicación recibida, justificante, fotografía</strong>{" "}
              o cualquier otro documento relacionado con tu caso.
            </div>
            <div
              style={{
                marginTop: 13,
            ...
            >
              <strong>Importante:</strong> si un documento tiene varias páginas, intenta
              subirlo completo. Si no sabes qué puede ser útil, adjunta el documento
              principal y todo lo que tengas relacionado con el problema. Nosotros
              revisaremos qué es relevante.
            </div>
            <div style={{ marginTop: 11, color: "#64748b", fontSize: 14 }}>
              Podrás añadir más documentación posteriormente si fuera necesario.
            </div>
          </div>
