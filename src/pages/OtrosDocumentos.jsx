...
export default function OtrosDocumentos() {
  ...
  return (
    <>
      <Seo
        title="Subir documentación del caso · RTM"
        description="Adjunta cualquier documento relacionado con el problema para que podamos clasificarlo y revisarlo."
      ...
      >
        ...
        >
          <header style={{ marginBottom: 24 }}>
            ...
            >
              Subir documentación del caso
            </h1>

            <p style={{ margin: 0, color: "#475569", fontSize: 17, lineHeight: 1.6 }}>
              Adjunta cualquier documento relacionado con el problema para que podamos clasificarlo y revisarlo.
            </p>
          </header>
