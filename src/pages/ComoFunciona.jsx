      ...
      <main className="cw-page">
        <section className="cw-hero">
          <div className="cw-container cw-hero-grid">
            ...
            <div className="cw-hero-visual" role="img" aria-label="Expediente y documentación organizados en un espacio de trabajo">
