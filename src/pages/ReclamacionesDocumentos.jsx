...
export default function ReclamacionesDocumentos() {
  ...
  return (
    <>
      <Seo
        title="Subir documentación de la reclamación · RTM"
        description="Adjunta billetes, reservas, facturas, comunicaciones y cualquier documento que acredite el problema."
      ...
      >
        ...
        >
          <header style={{ marginBottom: 24 }}>
            ...
            >
              Subir documentación de la reclamación
            </h1>

            <p style={{ margin: 0, color: "#475569", fontSize: 17, lineHeight: 1.6 }}>
              Adjunta billetes, reservas, facturas, comunicaciones y cualquier documento que acredite el problema.
            </p>
          </header>
