...
export default function DeudasDocumentos() {
  ...
  return (
    <>
      <Seo
        title="Subir documentación de morosidad · RTM"
        description="Adjunta la comunicación de Equifax, ASNEF, el justificante de pago y cualquier reclamación previa."
      ...
      >
        ...
        >
          <header style={{ marginBottom: 24 }}>
            ...
            >
              Subir documentación de morosidad
            </h1>

            <p style={{ margin: 0, color: "#475569", fontSize: 17, lineHeight: 1.6 }}>
              Adjunta la comunicación de Equifax, ASNEF, el justificante de pago y cualquier reclamación previa.
            </p>
          </header>
