...
export default function AdministracionDocumentos() {
  ...
  return (
    <>
      <Seo
        title="Subir requerimiento o resolución · RTM"
        description="Adjunta el requerimiento, la resolución y los documentos relacionados con el organismo público."
      ...
      >
        ...
        >
          <header style={{ marginBottom: 24 }}>
            ...
            >
              Subir requerimiento o resolución
            </h1>

            <p style={{ margin: 0, color: "#475569", fontSize: 17, lineHeight: 1.6 }}>
              Adjunta el requerimiento, la resolución y los documentos relacionados con el organismo público.
            </p>
          </header>
